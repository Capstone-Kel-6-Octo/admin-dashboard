...
export function Button({
  ...
  const variants = {
    primary: "bg-[#b3000d] hover:bg-[#91000a] text-white focus:ring-[#b3000d] shadow-sm",
    secondary: "bg-slate-100 hover:bg-slate-200 text-slate-700 focus:ring-slate-300",
    outline: "border border-slate-200 bg-transparent hover:bg-slate-50 text-slate-600 focus:ring-slate-200",
